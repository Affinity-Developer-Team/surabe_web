    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-12 col-12 d-flex justify-content-center align-items-center logo-home" style="background-color: #c9f8c8;">
        <div>
          ...
          <center>
            <h2 class="mb-4 bookin" style=" margin-bottom: 40px;">Set Your Booking</h2>
          </center>
          <br> <br>
          <form>
            <div class="row">
              ...
              <div class="col-md-6 mt-4">
                <div class="mb-4">
                  ...
                  <input type="text" class="form-control rounded " id="bookingDate" placeholder="ex: 11/03/2024">
                </div>
              </div>
            </div>
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-lg mt-4 mx-auto d-block " style="background-color: #2f682e; color: white; border-radius: 15px; width: 110px; font-size: 17px; font-family: jua;">Confirm</button>
