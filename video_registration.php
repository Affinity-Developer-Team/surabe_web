...
<head>
    ...
    <title>Video Portal Registration</title>
        ...
        <div class="row pt-5">
            <div class="left col-lg-6 col-md-12 col-sm-12">
                <div class="content">
                    ...
                    <h5 style=" font-size: 31px; font-weight: bold; margin-bottom: 30px;">Students Registration</h5>
            ...
            <div class="right col-lg-6 col-md-12 col-sm-12">
                ...
                <div class="content-2 d-flex flex-column">
                    ...
                    <label for="uname" class="lab">Email:</label>
                    <input type="text" id="uname" class="entry_f uname " placeholder="Enter Email" onclick="hidealert();">
                    ...
                    <label for="pw" class="lab">Re-type Password:</label>
                    <input type="password" id="pw" class="entry_f pw" placeholder="Re-type Password" onclick="hidealert();">
                    
                    

                    <button class="btn btn-primary log-btn mb-2" onclick="login();">Register</button>
                    <a href="video_login.php" class="text-decoration-none link-primary">I have an account</a>
